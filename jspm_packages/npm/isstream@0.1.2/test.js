...
var tape = require('tape'),
    ...
    util = require('util'),
    isStream = require('../isstream@0.1.2'),
    isReadable = require('../isstream@0.1.2').isReadable,
    isWritable = require('../isstream@0.1.2').isWritable,
    isDuplex = require('../isstream@0.1.2').isDuplex,
